package com.zapcloudstudios.enderflight.client.particle;
...
public abstract class EntityEnderFlightFX extends EntityFX
{
	...
	protected EntityEnderFlightFX(World world, double x, double y, double z)
	{
		super(world, x, y, z);
	}
	
	public EntityEnderFlightFX(World world, double x, double y, double z, double motionx, double motiony, double motionz)
	{
